...
// TODO: Eliminar extensión ? (realmente se llama a draw mesh)
//			... o al menos sustituir Texture por Vector2i (size)
//			... o bien pasar como argumento el MATERIAL (para asignar la textura) [pero a qué propiedad del shader? definir]
...
namespace JuFramework
{
	public abstract partial class Graphics
	{
		...
		//public void DrawTexture(Texture texture, Vector2f position, IntRect source, Color color, Vector2f origin);
		...
		//public void DrawTexture(Texture texture, IntRect destination, IntRect source, Color color, Vector2f origin);
