...
namespace JuFramework
{
	public partial struct Color32
	{
		...
		{
			get { return rValue; }
			set { rValue = (byte)Math.Clamp(value, 0, 255); }
		}

		public byte g
		{
			get { return gValue; }
			set { gValue = (byte)Math.Clamp(value, 0, 255); }
		}

		public byte b
		{
			get { return bValue; }
			set { bValue = (byte)Math.Clamp(value, 0, 255); }
		}

		public byte a
		{
			get { return aValue; }
			set { aValue = (byte)Math.Clamp(value, 0, 255); }
		}
